...
// Exportar el contexto para uso en el hook separado
export { ModalContext };
...
const Modal: React.FC<{
  ...
  config: ModalConfig;
}> = ({ isOpen, onClose, children, config }) => {
  const {
    title,
    maxWidth = 'md',
    fullWidth = true,
...
export const ModalProvider: React.FC<ModalProviderProps> = ({ children }) => {
  // Usa el hook personalizado desde hooks/useModal.ts
  ...
  const value = {
    ...
    forceCloseModal: modal.forceCloseModal,
  };
