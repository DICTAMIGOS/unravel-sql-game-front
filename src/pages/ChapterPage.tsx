...
import type { StoryImage, ChallengeSequence } from '../types/game';
...
export const ChapterPage: React.FC = () => {
  ...
  const { levels, isLoading, completeLevel, gameProgress } = useGameState();
    ...
    return (
      <div className="min-h-screen bg-gray-900 text-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 font-mono">Cargando misión...</p>
        </div>
      </div>
    );
  }
  ...
  if (!level) {
    return (
      <div className="min-h-screen bg-gray-900 text-gray-100 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-400 font-mono">Misión no encontrada</p>
        </div>
      </div>
    );
  }
              ...
              {currentStep.type === 'image' ? (
                ...
                <div>
                  ...
                  <ChallengeCard
                    ...
                    timeLimit={getTimeLimitForDifficulty(gameProgress.selectedDifficulty)}
