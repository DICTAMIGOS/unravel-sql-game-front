...
import { User, Lock, Eye, EyeOff, Shield, Fingerprint, AlertCircle } from 'lucide-react';
        ...
        >
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="bg-red-900/30 border border-red-600 rounded-lg p-4 mb-6"
            >
              <div className="flex items-start gap-3">
                <AlertCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-red-300 font-mono text-sm font-semibold mb-1">
